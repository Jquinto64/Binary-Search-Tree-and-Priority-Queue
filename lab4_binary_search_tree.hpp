...
public:
	...
	bool Exists(TaskItem* original, TaskItem val) const;
	...
	bool Insert(TaskItem* node, TaskItem val);

	// PURPOSE: Removes the node with the value val from the tree
	// returns true if successful; returns false otherwise
	bool remove(TaskItem val);

	bool RemoveLeaf(TaskItem* parent,TaskItem* node, TaskItem val);
